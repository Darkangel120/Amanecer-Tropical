...
public class FlightAgency {
    ...
    @OneToMany(mappedBy = "agenciaVuelo")
    ...
    public List<Flight> getVuelos() { return vuelos; }
    public void setVuelos(List<Flight> vuelos) { this.vuelos = vuelos; }
}